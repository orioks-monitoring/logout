...
@user_router.get("/{user_telegram_id}")
...
@user_router.post("/{user_telegram_id}/logout", status_code=status.HTTP_204_NO_CONTENT)
...
@user_router.patch("/{user_telegram_id}/login", status_code=status.HTTP_200_OK)
